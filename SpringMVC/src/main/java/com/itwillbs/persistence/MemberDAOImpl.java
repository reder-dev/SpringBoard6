...
//@Repository : '저장소'의 동작을 수행하는 객체
// 				(DB관련 처리)
//				스프링(root-context.xml)이 해당객체를 DAO 객체로 인식하겟다 설정
...
public class MemberDAOImpl implements MemberDAO {
	...
	*/	
	...
	public MemberVO loginMember(MemberVO loginVO) {
		...
		// => 코드 생략 / Mybatis가 대신수행ㅐ줌
		MemberVO resultVO = sqlSession.selectOne(NAMESPACE+ "loginCheck", loginVO);
...
//		//paramMap.put("SQL구문에서 매핑된 이름", id);
//		paramMap.put("userid", id);
//		paramMap.put("userpw", pw);
//		
//		MemberVO resultVO = sqlSession.selectOne(NAMESPACE+ "loginCheck", paramMap);
